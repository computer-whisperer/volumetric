...
pub struct AdaptiveMeshConfig2 {
    ...
    /// Configuration for sharp feature reconstruction (region-based edge and
...
pub struct MeshingStats2 {
    ...
    pub sharp_regions: usize,
    /// Feature-zone vertices considered for snapping
    pub sharp_candidates: usize,
    /// Vertices snapped onto fitted edge lines
...
/// Intermediate result from Stage 4, in f64 precision so the optional sharp
/// feature stage can operate before the final f32 conversion.
pub struct Stage4Result {
    /// Refined vertex positions
    ...
    F: SamplerFn,
{
    ...
    // =========================================================================
    // Phase 4c: Normal Refinement (optional)
    // =========================================================================
