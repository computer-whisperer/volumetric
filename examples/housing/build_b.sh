...
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[0.0140,-0.0165,0.0013]' --input 'json:[0.0210,0.0115,0.0049]' --output-id slot_e --no-export
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[-0.0110,-0.0245,0.0013]' --input 'json:[0.0100,-0.0140,0.0049]' --output-id slot_s --no-export
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[-0.0210,-0.0145,0.0013]' --input 'json:[-0.0140,0.0065,0.0049]' --output-id slot_w --no-export
...
# 45-degree eave wedges: slab top face rotated onto the plane through the
# slot ceiling at the inner wall face, rising outward at 45 degrees.
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[-0.0110,-0.0060,-0.0200]' --input 'json:[0.0100,0.0060,0]' --output-id wedge_s0 --no-export
op --operator rotation_operator --input asset:wedge_s0 --input 'json:{"rx_deg":-45.0}' --output-id wedge_s1 --no-export
op --operator translate_operator --input asset:wedge_s1 --input 'json:{"dx":0.0,"dy":-0.02145,"dz":0.0049}' --output-id wedge_s --no-export
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[-0.0060,-0.0165,-0.0200]' --input 'json:[0.0060,0.0115,0]' --output-id wedge_e0 --no-export
op --operator rotation_operator --input asset:wedge_e0 --input 'json:{"ry_deg":-45.0}' --output-id wedge_e1 --no-export
op --operator translate_operator --input asset:wedge_e1 --input 'json:{"dx":0.01745,"dy":0.0,"dz":0.0049}' --output-id wedge_e --no-export
op --operator rectangular_prism_operator --input 'json:{}' --input 'json:[-0.0060,-0.0145,-0.0200]' --input 'json:[0.0060,0.0065,0]' --output-id wedge_w0 --no-export
op --operator rotation_operator --input asset:wedge_w0 --input 'json:{"ry_deg":45.0}' --output-id wedge_w1 --no-export
op --operator translate_operator --input asset:wedge_w1 --input 'json:{"dx":-0.01745,"dy":0.0,"dz":0.0049}' --output-id wedge_w --no-export
...
op --operator boolean_operator --input asset:cut3 --input asset:slot_usb --input 'json:{"op":"union"}' --output-id cut4 --no-export
op --operator boolean_operator --input asset:cut4 --input asset:wedge_s --input 'json:{"op":"union"}' --output-id cut5 --no-export
op --operator boolean_operator --input asset:cut5 --input asset:wedge_e --input 'json:{"op":"union"}' --output-id cut6 --no-export
op --operator boolean_operator --input asset:cut6 --input asset:wedge_w --input 'json:{"op":"union"}' --output-id cuts --no-export
